...
class SegWitTest(HorusTestFramework):
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older horusd's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let horusd fill it in.
