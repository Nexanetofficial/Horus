...
By default, horusd will dump mempool on shutdown and
...
class MempoolPersistTest(HorusTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent horusd from writing mempool.dat to disk. Verify that `savemempool` fails")
