...
Verify that a horusd node can use an external signer command.
...
class RPCSignerTest(HorusTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart horusd with -signer=<cmd>',
