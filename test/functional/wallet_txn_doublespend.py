...
class TxnMallTest(HorusTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 HRS:
        ...
        # First: use raw transaction API to send 1240 HRS to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 HRS coin each
        ...
        # Node0's balance should be starting balance, plus 50HRS for another
        ...
        # Node0's total balance should be starting balance, plus 100HRS for
