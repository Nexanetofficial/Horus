...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the HorusTestFramework
    pass


class ExampleTest(HorusTestFramework):
    # Each functional test is a subclass of the HorusTestFramework class.
    ...
    def custom_method(self):
        ...
        HorusTestFramework class so other tests can use it."""
