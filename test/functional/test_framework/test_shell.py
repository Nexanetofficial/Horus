...
class TestShell:
    """Wrapper Class for HorusTestFramework.

    The TestShell class extends the HorusTestFramework
    ...
    class __TestShell(HorusTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by HorusTestFramework child class.
            self.num_nodes = 1
