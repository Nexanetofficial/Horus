...
class TransactionTimeRescanTest(HorusTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine HRS and create transactions
        ...
        # generate some hrs to create transactions and check blockcount
        ...
        # send 10 hrs to user's first watch-only address
        self.log.info('Send 10 hrs to user')
        ...
        # send 5 hrs to our second watch-only address
        self.log.info('Send 5 hrs to user')
        ...
        # send 1 hrs to our third watch-only address
        self.log.info('Send 1 hrs to user')
