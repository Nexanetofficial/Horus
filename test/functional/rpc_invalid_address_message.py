...
class InvalidAddressErrorMessageTest(HorusTestFramework):
    ...
    def test_validateaddress(self):
        ...
        assert_raises_rpc_error(-1, "Return information about the given horus address.", node.validateaddress)
