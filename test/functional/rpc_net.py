...
class NetTest(HorusTestFramework):
    ...
    def test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(address=ipv6_addr, port=15768)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 15768)
    ...
    def test_addpeeraddress(self):
        ...
        assert_equal(node.addpeeraddress(address="", port=15768), {"success": False})
