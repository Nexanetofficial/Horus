...
"""Verify that starting horus with -h works as expected."""

from test_framework.test_framework import HorusTestFramework
from test_framework.util import assert_equal

class HelpTest(HorusTestFramework):
    ...
    def run_test(self):
        self.log.info("Start horus with -h for help text")
        ...
        self.log.info("Start horus with -version for version information")
        ...
        self.log.info("Start horusd with -fakearg to make sure it does not start")
