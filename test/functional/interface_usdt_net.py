...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/horus/horus/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(HorusTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our horusd node")
