...
#ifndef HORUS_CRYPTO_CHACHA_POLY_AEAD_H
#define HORUS_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@horus.
 *
 ...
 *
 * The chacha20-poly1305@horus combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@horus cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@horus are relatively fast in
...
#endif // HORUS_CRYPTO_CHACHA_POLY_AEAD_H
