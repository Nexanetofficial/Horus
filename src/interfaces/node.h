...
#ifndef HORUS_INTERFACES_NODE_H
#define HORUS_INTERFACES_NODE_H
...
//! Top-level interface for a horus node (horusd process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or horus.conf.
