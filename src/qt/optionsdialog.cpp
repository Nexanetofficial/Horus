      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->horusAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->horusAtStartup);
    ...
    ui->horusAtStartup->setToolTip(ui->horusAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->horusAtStartup->setText(ui->horusAtStartup->text().arg(PACKAGE_NAME));

    ui->openHorusConfButton->setToolTip(ui->openHorusConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new HorusUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->horusAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSHRSontrols);
...
void OptionsDialog::on_openHorusConfButton_clicked()
{
