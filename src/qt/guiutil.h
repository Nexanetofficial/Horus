...
#ifndef HORUS_QT_GUIUTIL_H
#define HORUS_QT_GUIUTIL_H
...
/** Utility functions used by the Horus Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "horus:" URI into recipient object, return true on successful parsing
