...
#ifndef HORUS_QT_HORUSUNITS_H
#define HORUS_QT_HORUSUNITS_H
...
/** Horus unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class HorusUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit HorusUnits(QObject *parent);

    /** Horus units.
      @note Source: https://en.horus.it/wiki/Units . Please add only sensible ones
     */
    enum class Unit {
        HRS,
        mHRS,
