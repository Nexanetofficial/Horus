...
//! Entry point for HorusApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &HorusApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for HorusGUI tests.
void AppTests::guiTests(HorusGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &HorusGUI::consoleShown, this, &AppTests::consoleTests);
