...
{
    // Test regression https://github.com/horus/horus/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/horus-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/horus-core/gui/pull/568.
    // With fListen=false in ~/.config/Horus/Horus-Qt.conf and all else left as default,
    // horus-qt should set both -listen and -listenonion to false and start successfully.
