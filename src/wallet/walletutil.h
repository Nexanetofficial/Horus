...
#ifndef HORUS_WALLET_WALLETUTIL_H
#define HORUS_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! horus from opening the wallet, thinking it was newly created, and
...
#endif // HORUS_WALLET_WALLETUTIL_H
