...
#ifndef HORUS_WALLET_TRANSACTION_H
#define HORUS_WALLET_TRANSACTION_H
...
public:
     ...
     * on this horus node, and set to 0 for transactions that were created
...
#endif // HORUS_WALLET_TRANSACTION_H
