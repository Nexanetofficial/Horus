...
#ifndef HORUS_WALLET_SCRIPTPUBKEYMAN_H
#define HORUS_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Horus Core wallet was originally a collection of unrelated private
...
#endif // HORUS_WALLET_SCRIPTPUBKEYMAN_H
