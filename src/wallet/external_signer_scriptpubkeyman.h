...
#ifndef HORUS_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define HORUS_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // HORUS_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
