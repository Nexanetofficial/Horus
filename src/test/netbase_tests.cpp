...
{
    BOOST_CHECK(TestSplitHost("www.horuscore.org", "www.horuscore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.horuscore.org]", "www.horuscore.org", 0));
    BOOST_CHECK(TestSplitHost("www.horuscore.org:80", "www.horuscore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.horuscore.org]:80", "www.horuscore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("127.0.0.1:15768", "127.0.0.1", 15768));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:15768", "127.0.0.1", 15768));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:15768", "::ffff:127.0.0.1", 15768));
    BOOST_CHECK(TestSplitHost("[::]:15768", "::", 15768));
    BOOST_CHECK(TestSplitHost("::15768", "::15768", 0));
    BOOST_CHECK(TestSplitHost(":15768", "", 15768));
    BOOST_CHECK(TestSplitHost("[]:15768", "", 15768));
    ...
    BOOST_CHECK(TestSplitHost("www.horuscore.org:65536", "www.horuscore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.horuscore.org:0", "www.horuscore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.horuscore.org:", "www.horuscore.org:", 0, false));
}
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:15768", "127.0.0.1:15768"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:15768", "[::]:15768"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
