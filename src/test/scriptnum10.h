...
#ifndef HORUS_TEST_SCRIPTNUM10_H
#define HORUS_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Horus Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // HORUS_TEST_SCRIPTNUM10_H
