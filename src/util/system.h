 ...
 */
#ifndef HORUS_UTIL_SYSTEM_H
#define HORUS_UTIL_SYSTEM_H
...
extern const char * const HORUS_CONF_FILENAME;
extern const char * const HORUS_SETTINGS_FILENAME;
