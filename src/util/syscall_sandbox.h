...
#ifndef HORUS_UTIL_SYSCALL_SANDBOX_H
#define HORUS_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during horusd initialization if Horus Core was compiled
...
#endif // HORUS_UTIL_SYSCALL_SANDBOX_H
