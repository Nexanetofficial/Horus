...
#ifndef HORUS_SCRIPT_STANDARD_H
#define HORUS_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a horus address
 */
...
/**
 * Generate a Horus scriptPubKey for the given CTxDestination. Returns a P2PKH
