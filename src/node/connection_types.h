...
#ifndef HORUS_NODE_CONNECTION_TYPES_H
#define HORUS_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/horus-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Horus’s Peer-to-Peer Network")
...
#endif // HORUS_NODE_CONNECTION_TYPES_H
