...
This document provides guidelines for internationalization of the Horus Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `horus_en.ts` remains unchanged.
