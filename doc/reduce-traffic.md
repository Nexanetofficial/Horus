...
By default, Horus Core allows up to 125 connections to different peers, 10 of
...
limits are tiny. Keep in mind that horus's trustless model works best if you are
