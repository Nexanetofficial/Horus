Horus Core version 0.9.4 is now available from:

  https://horus.org/bin/0.9.4/
...
this update is incompatible with the Horus system and could lead to consensus
forks.

Horus Core released binaries from https://horus.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~horus/+archive/ubuntu/horus
- A third-party or self-compiled Horus Core

upgrade to Horus Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
