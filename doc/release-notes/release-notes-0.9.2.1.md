Horus Core version 0.9.2.1 is now available from:

  https://horus.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 HRS to 0.01 HRS
...
- Fix "Start horus on system login"
