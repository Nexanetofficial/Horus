Horus Core version 0.10.4 is now available from:

  <https://horus.org/bin/horus-core-0.10.4/>
...
- #6953 `43c2789` Split horus-tx into its own package
- #6953 `dfe0d4d` Include horus-tx binary on Debian/Ubuntu
