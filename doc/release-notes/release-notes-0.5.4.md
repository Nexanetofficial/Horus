Horus version 0.5.4 is now available for download at:
http://sourceforge.net/projects/horus/files/Horus/horus-0.5.4/
...
http://gitorious.org/horus/horusd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Horus-Qt notifications under Growl 1.3.
Increase required age of Horus-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxHorus properly when installing Horus-Qt over it. (Windows)
