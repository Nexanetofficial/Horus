Horus-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/horus/files/Horus/horus-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Horus
...
New/changed settings (command-line or horus.conf file)
--------------------------------------------------------
