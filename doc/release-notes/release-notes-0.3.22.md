Download URL: https://sourceforge.net/projects/horus/files/Horus/horus-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 HRS fee schedule (users still pay 0.01 HRS per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #horus00 - #horus99
