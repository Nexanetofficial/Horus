Horus Core version 0.13.2 is now available from:

  <https://horus.org/bin/horus-core-0.13.2/>
...
- #8908 `4a974b2` Update horus-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow horus-tx to create v2 transactions (hrsdrak)
