...
complete --command horusd --no-files

# Extract options
function __fish_horusd_get_options
...
complete \
    --command horusd \
    --arguments "(__fish_horusd_get_options --nofiles)"
