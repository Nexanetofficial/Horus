...
# Extract options
function __fish_horus_tx_get_options
...
# Extract commands
function __fish_horus_tx_get_commands
...
complete \
    --command horus-tx \
    --condition "not __fish_horus_seen_cmd (__fish_horus_tx_get_commands --commandsonly)" \
    --arguments "(__fish_horus_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command horus-tx \
    --arguments "(__fish_horus_tx_get_commands)" \
    --no-files
