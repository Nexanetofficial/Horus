...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef HORUS_CHAINPARAMSSEEDS_H\n')
    g.write('#define HORUS_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the horus network\n')
    ...
    g.write('#endif // HORUS_CHAINPARAMSSEEDS_H\n')
