...
Arguments:
    <base_directory> - The base directory of a horus source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Horus Core developers'
...
Arguments:
    <file> - A source file in the horus repository.
"""
