# Bootstrappable Horus Core Builds

This directory contains the files necessary to perform bootstrappable Horus
Core builds.
...
To build Horus Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Horus Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/horus-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/horus-core/guix.sigs).
