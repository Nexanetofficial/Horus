...
"""Example logging Horus Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/horusd
...
def main(horusd_path):
    ...
    b = BPF(text=program, usdt_contexts=[horusd_with_usdts])
