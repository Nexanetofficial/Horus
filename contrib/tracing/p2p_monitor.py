...
""" Interactive horusd P2P network traffic monitor utilizing USDT and the
    net:inbound_message and net:outbound_message tracepoints. """

# This script demonstrates what USDT for Horus Core can enable. It uses BCC
...
def main(horusd_path):
    ...
    horusd_with_usdts.enable_probe(
